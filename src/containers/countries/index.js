          ...
          <div className="countryBlock" key={pais._id}>
            ...
            <div className="globalBlock__data">
              <div className="globalBlock__details">
                ...
                <div>
                  <strong>{pais.NewConfirmed}</strong>
                </div>
              </div>
              <div className="globalBlock__details">
                <div>
                ...
                <div>
                  <strong>{pais.NewDeaths}</strong>
                </div>
              </div>
              <div className="globalBlock__details">
                <div>
                  <p>Nuevos recuperados</p>
                </div>
                <div>
                  <strong>{pais.NewRecovered}</strong>
                </div>
              </div>
              <div className="globalBlock__details">
                <div>
                ...
                <div>
                  <strong>{pais.TotalDeaths}</strong>
                </div>
              </div>
              <div className="globalBlock__details">
                <div>
                ...
                <div>
                  <strong>{pais.TotalConfirmed}</strong>
                </div>
              </div>
              <div className="globalBlock__details">
                <div>
                  <p>Recuperados total</p>
                </div>
                <div>
                  <strong>{pais.TotalRecovered}</strong>
                </div>
              </div>
            </div>
          </div>
